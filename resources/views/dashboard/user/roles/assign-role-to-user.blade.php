    ...
    <main id="main-container">
        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Assign role to user</h1>
                </div>
            </div>
        </div>
        <!-- END Hero -->
        ...
        <div class="content"  style="width: 70%; align-self: center" >
            ...
            <form class="js-validation"
                  action="{{ route('role.assign.store', $user->id) }}"
                  method="post"
                ...
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        <!-- Regular -->
                        <h2 class="content-heading">User and Role Details</h2>

                        <div class="mb-4">
                            <label class="form-label" for="val-username">User name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="val-username" name="name" value="{{ $user->name }}" placeholder="Enter role name" disabled>

                        </div>

                        <div class="mb-4">
                            <label class="form-label" for="val-username">Select Role <span class="text-danger">*</span></label>
