        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Add New Currency</h1>
                </div>
            </div>
        </div>
        <!-- END Hero -->
        ...
        <div class="content"  style="width: 70%; align-self: center" >
            ...
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    <!-- Regular -->
                    <h2 class="content-heading">Currency Information</h2>

                    <div class="mb-4">
                        <label class="form-label" for="name">Official Currency Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="name" name="off_name" value="{{ old('off_name')}}">

                        @if($errors->any('off_name'))
                            <p style="color: red; font-size: small">{{$errors->first('off_name')}}</p>
                        @endif

                    </div>

                    <div class="mb-4">
                        <label class="form-label" for="symbol">Currency Code<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="symbol" name="currency_code" value="{{ old('currency_code')}}">

                        @if($errors->any('currency_code'))
                            <p style="color: red; font-size: small">{{$errors->first('currency_code')}}</p>
                        @endif
                    ...
                    <div class="mb-4">
                        <label class="form-label" for="val-username">Country <span class="text-danger">*</span></label>
