        ...
        <div class="content"  style="width: 70%; align-self: center" >
            ...
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    ...
                    <div class="mb-4">
                        <label class="form-label" for="first">First Currency <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="first" name="first_currency" value="{{ old('first_currency')}}">

                        @if($errors->any('first_currency'))
                            <p style="color: red; font-size: small">{{$errors->first('first_currency')}}</p>
                        @endif

                    </div>

                    <div class="mb-4">
                        <label class="form-label" for="second">Second Currency <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="second" name="second_currency" value="{{ old('second_currency')}}">

                        @if($errors->any('second_currency'))
                            <p style="color: red; font-size: small">{{$errors->first('second_currency')}}</p>
                        @endif
