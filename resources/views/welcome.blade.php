<x-layout.app>
    ...
    <x-layout.custom.navigation-bar></x-layout.custom.navigation-bar>
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="md:col-span-6 mt-8 md:mt-0">
                    <div class="lg:ml-5">
                        ...
                        <a href="#freeAccount" class="btn bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-full">Get Started</a>
                    </div>
                </div>
            </div>
        </div><!--end container-->
    ...
    <!-- Start -->
    <section class="relative md:py-24 py-16 overflow-hidden" id="freeAccount">
        <div class="container">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="lg:col-span-7 md:col-span-6">
                    <div class="lg:ml-5">
                        <h3 class="mb-4 md:text-3xl md:leading-normal text-3xl leading-normal font-semibold">Create a Free Account</h3>

                        <div class="bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800 p-6">
                            <h1 class="mb-6 text-1xl text-red-600 leading-normal font-medium">All fields are required!</h1>

                            <form method="post" name="myForm" id="myForm" action="{{ route('register') }}">
                                @csrf
                                ...
                                <div class="grid grid-cols-1">
                                    <div class="mb-5">
                                        <div class="text-left">
                                            ...
                                            <div class="form-icon relative mt-2">
                                                <i data-feather="lock" class="w-4 h-4 absolute top-3 left-4"></i>
                                                <input name="password" type="password" id="subject" class="form-input pl-11" placeholder="Password :">
                                    ...
                                    <div class="mb-5">
                                        <div class="text-left">
                                            ...
                                            <div class="form-icon relative mt-2">
                                                <i data-feather="lock" class="w-4 h-4 absolute top-3 left-4"></i>
                                                <input name="password_confirmation" type="password" id="subject" class="form-input pl-11" placeholder="Password :">
                                ...
                                <button type="submit" id="submit" name="send" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md justify-center flex items-center">Get Started</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <!-- End -->
    <x-layout.custom.back-to-top></x-layout.custom.back-to-top>

    <x-layout.custom.footer></x-layout.custom.footer>
