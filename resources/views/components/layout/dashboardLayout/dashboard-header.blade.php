        ...
        <div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
                    <div class="bg-primary-dark rounded-top fw-semibold text-white text-center p-3">
                        <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ \Illuminate\Support\Facades\Auth::user()->image_path }}" alt="">
{{--                        <img class="img-avatar img-avatar48 img-avatar-thumb" src="/public/profile/hero.jpg" alt="">--}}
                        <div class="pt-2">
                            <h4 class="text-white fw-semibold"> {{ \Illuminate\Support\Facades\Auth::user()->name }}</h4>
                        </div>
                    </div>
                    <div class="p-2">
                        <a class="dropdown-item" href="{{ route("profile") }}">
                            <i class="fa fa-fw fa-cog me-1"></i> Profile
                        </a>
                        <div role="separator" class="dropdown-divider"></div>
                        <p class="dropdown-item">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-light"><i class="fa fa-fw fa-arrow-alt-circle-left me-1"></i> Log Out</button>
                            </form>
                        </p>
                    </div>
                </div>
