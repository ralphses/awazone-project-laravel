...
<main id="main-container">
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-6">
                <!-- Bank Account #1 -->
                <a class="block block-rounded block-link-shadow" href="{{ route('user.pay') }}">
                    ...
                    <div class="block-content block-content-full block-content-sm text-center bg-body-light">
                        <span class="fs-sm text-muted">Last TopUp: N2000.00</span>
                    </div>
                </a>
                <!-- END Bank Account #1 -->
            </div>
            <div class="col-lg-6">
                ...
                <a class="block block-rounded block-link-shadow" href="">
                    ...
                    <div class="block-content block-content-full block-content-sm text-center bg-body-light">
                        <span class="fs-sm text-muted">Last Withdrawal: N2000.00</span>
                    </div>
                </a>
                <!-- END Bank Account #1 -->
            </div>
